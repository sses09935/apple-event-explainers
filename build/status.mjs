...
export function inspectStatus(root=ROOT){
 ...
 return {
  ...
  public_source:{status:'checked',file_count:source.entries.length},verification,clean_rebuild:rebuild,
  ...
  limits:['Local snapshot only; saved verification must match current input, public source and tested output.','Preflight is not full engineering verification or semantic approval.','Historical delivery and deployment receipts are not used to infer current remote state.']
 };
}
